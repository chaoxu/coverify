---
name: autoprover-exploration-planner
description: Plan Autoprover mathematical exploration from current Cosheaf knowledge, live issues, PRs, and tried routes. Use when deciding what routes, computations, oracle calls, or issues are worth trying next without repeating failed work.
---

# Autoprover Exploration Planner
...
1. Use `$autoprover-context-builder` first unless a fresh context summary is
   already present.
