...
This directory is the durable home for Autoprover operational skills.
...
1. create or delete `skills/autoprover-*/SKILL.md`,
2. create or delete `skills/autoprover-*/agents/openai.yaml`,
