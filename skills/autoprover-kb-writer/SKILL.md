...
description: Convert useful Autoprover source material into compact Cosheaf wiki or PR content without adding new mathematics. Use for oracle output, checked calculations, failed routes, source notes, status notes, exploratory scripts, and other material that should become durable knowledge.
---
