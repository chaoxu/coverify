---
name: autoprover-proof-review
description: Review Autoprover mathematical PRs for correctness before merge. Use when a Cosheaf PR proposes proofs, examples, computations, obstructions, literature notes, source-backed claims, status summaries, or any correctness-relevant knowledge-base change.
---

# Autoprover Proof Review
