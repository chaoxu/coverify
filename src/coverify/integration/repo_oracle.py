    ...
    *,
    ...
    return "\n".join(
        [
            ...
            "- Do not use `>` blockquote syntax; Coflat removed it. Use a `::: {.blockquote}` fenced div when set-off quotation is genuinely needed.",
    ...
    return "\n".join(
        [
            ...
            *preference_block,
            ...
            "- Do not use `>` blockquote syntax; use a `::: {.blockquote}` fenced div when set-off quotation is genuinely needed.",
            *fallback_shape_block,
        ],
    )
    ...
    *,
    ...
    return "\n".join(
        [
            ...
            "Reject final answers that use `>` blockquote syntax; Coflat removed",
            "it, and set-off quotation belongs in a `::: {.blockquote}` fenced",
            "div.",
