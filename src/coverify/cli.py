...
def cmd_scaffold_workdir(args: argparse.Namespace) -> int:
    ...
    files: dict[Path, tuple[str, bool]] = {
        ...
        workdir / "AGENTS.md": (
            ...
            "writing or editing pages, load the \"Rules for Agents\" section at the top of\n"
            "Coflat's FORMAT.md (https://github.com/chaoxu/coflat/blob/main/FORMAT.md):\n"
            "one paragraph per source line (never hard-wrap prose), no `>` blockquotes,\n"
            "fenced divs with stable ids for theorem-like blocks, `$...$` math.\n\n"
