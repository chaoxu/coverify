        ...
        workdir / ".env.example": (
            "\n".join(
                [
                    ...
                    "",
                    'export COSHEAF_API_URL="https://cosheaf.lab/api/v1"',
                    f'export COSHEAF_WORKSPACE="{workspace}"',
                    'export COSHEAF_INSECURE="1"',
                    "",
                    ...
                    'export CHATGPT_CLI="/Users/chaoxu/playground/chatgpt-cli/.venv/bin/chatgpt-cli"',
        ...
        workdir / "bin" / "coverify": (
            "\n".join(
                [
                    ...
                    "fi",
                    "",
                    'export COSHEAF_API_URL="${COSHEAF_API_URL:-https://cosheaf.lab/api/v1}"',
                    f'export COSHEAF_WORKSPACE="${{COSHEAF_WORKSPACE:-{workspace}}}"',
                    'export COSHEAF_INSECURE="${COSHEAF_INSECURE:-1}"',
        ...
        workdir / "bin" / "chatgpt-coverify": (
            "\n".join(
                [
                    ...
                    'CHATGPT_CLI="${CHATGPT_CLI:-/Users/chaoxu/playground/chatgpt-cli/.venv/bin/chatgpt-cli}"',
        ...
        workdir / "config" / "qed-chatgpt-oracle.yaml": (
            "\n".join(
                [
                    ...
                    "",
                    "chatgpt:",
                    '  cli_path: "/Users/chaoxu/playground/chatgpt-cli/.venv/bin/chatgpt-cli"',
